...
namespace Development {
    ...
    private:
        ...
        void identifySuperposedLinels(Curve::ConstIterator curveBegin,
                                      Curve::ConstIterator curveEnd,
                                      std::map<SCell,bool>& superposedLinels);

        void createDilatedPixelsTerminalArcs(Curve& innerCurve,
                                             Curve& outerCurve,
                                             LinelWeightMap& weightMap,
                                             double* distrFrg,
                                             double* distrBkg);

        void createOriginalPixelsTerminalArc(Curve& innerCurve,
                                             LinelWeightMap& weightMap,
                                             double* distrFrg,
                                             double* distrBkg);
